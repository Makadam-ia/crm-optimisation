...
async function getDashboardStats() {
  try {
    ...
    const tourneesDuJour = demandes.filter(d => d.statut === 'PlanifiÃ©').length;
    const aFacturer = demandes.filter(d => d.statut === 'TerminÃ©').length;
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
      ...
      <div className="p-6 rounded-xl bg-white dark:bg-gray-950 border border-gray-100 shadow-sm">
        <div className="flex items-center gap-3 text-gray-500 mb-2">
          ...
          <h3 className="font-medium">PlanifiÃ©es (TournÃ©es)</h3>
        </div>
      ...
      <div className="p-6 rounded-xl bg-white dark:bg-gray-950 border border-gray-100 shadow-sm">
        <div className="flex items-center gap-3 text-gray-500 mb-2">
          ...
          <h3 className="font-medium">Ã€ facturer</h3>
        </div>
...
async function InterventionsList() {
  ...
  if (interventions.length === 0) return <p className="text-gray-500 italic p-3">Aucune demande rÃ©cente trouvÃ©e.</p>;
  ...
  return (
    <div className="p-4 md:p-8 max-w-6xl mx-auto">
      <header className="mb-8">
        <h1 className="text-2xl md:text-3xl font-bold mb-2">Bonjour, Artisan ðŸ‘‹</h1>
        <p className="text-gray-500">Voici le rÃ©sumÃ© de votre activitÃ© d'aujourd'hui.</p>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <section className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
          <div className="p-4 border-b border-gray-100 flex items-center gap-2">
            ...
            <h2 className="font-bold">DerniÃ¨res Demandes (n8n)</h2>
          </div>
